    ...
    for epoch in range(num_epochs):
        ...
        for data in train_dataloader:
            ...
            if epoch == num_epochs - 1:
                ...
                ac_predicted_coordinate_df['scan_path'] = data['scan_path']
                ...
                pc_predicted_coordinate_df['scan_path'] = data['scan_path']

                predicted_coordinates_df = ac_predicted_coordinate_df.merge(pc_predicted_coordinate_df, how = 'inner', on = ['scan_id', 'scan_path'])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--hp_trial_results_path', type=str, default=str((Path() / 'unet_results_hp_optim/hp_trial_results.csv').resolve()))
