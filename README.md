...
|   └── scan_info.csv
│
└── unet_results_hp_optim/        # OUTPUT: Generated by train_hptune_test.py, contains results of hyperparameter tuning in the 5-fold CV setting
|   ├── trial_results.csv         #Main record required for selecting the optimal hyperparameters
|   └── ...
│
├── unet_results_aug/            # OUTPUT: Generated by trainWaug_test.py, contains results of training models at gradually increasing levels of augmentation
│   ├── AugmentedTimes2/
