...
> **🚧 Note:** We are currently in the process of cleaning up code comments and expanding inline documentation. While the core logic is fully functional and matches the manuscript, you may encounter sparse docstrings in some helper functions. We will be updating the repository regularly over the coming weeks.
...
### Data Setup
Because medical images are large and private, **this repository does not contain data** except for the CT-template reproduced from [](). You must create the following folder structure locally and populate it with your own files to run the code.
